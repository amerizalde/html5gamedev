...
BasicGame.Preloader.prototype = {
  preload: function () {
    ...
    this.load.image('tile_1', 'assets/polygon_1.png');
    this.load.image('tile_2', 'assets/polygon_2.png');
    this.load.image('tile_3', 'assets/polygon_3.png');
    this.load.image('tile_4', 'assets/polygon_4.png');
    this.load.image('tile_5', 'assets/polygon_5.png');
    this.load.image('tile_6', 'assets/polygon_6.png');
