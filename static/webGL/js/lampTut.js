function createSceneTut(engine) {
    ...
    // params == name, position, scene
    var pointy1 = new BABYLON.PointLight("Omni",
        new BABYLON.Vector3(0, 100, 100),
        scene);
    pointy1.diffuse = new BABYLON.Color3(1, 0, 0); // red diffuse
    pointy1.specular = new BABYLON.Color3(1, 1, 1); // white specular
    pointy1.intensity = 0.8;

    var sunny1 = new BABYLON.DirectionalLight("Dir0",
        new BABYLON.Vector3(10, 100, 100),
        scene);
    sunny1.diffuse = new BABYLON.Color3(0.1, 0.9, 0.9);
    sunny1.specular = new BABYLON.Color3(1, 1, 1);
